  ...
  return tgRequest(token, 'sendMessage', {
    ...
    reply_markup: {
      inline_keyboard: [
        ...
        [
          { text: '🍋 มะนาว รัน',    callback_data: 'run:manao:full'         },
          { text: '🍋 มะนาว สถานะ',  callback_data: 'run:manao:status'       },
        ],
        [
          { text: '⚽ มะกรูด รัน',   callback_data: 'run:makrut:full'        },
          { text: '⚽ มะกรูด สถานะ', callback_data: 'run:makrut:status'      },
        ],
        [
